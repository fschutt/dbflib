...
class DBaseHeader
{
    public:
        ...
        uint32_t m_numRecordsInDB = 0;          //BYTE 4-7 32-bit nr of records
        uint16_t m_numBytesInHeader = 0;        //BYTE 8-9 16 bit nr of bytes in header
        uint16_t m_numBytesInRecord = 0;        //BYTE 10-11 16 bit nr of bytes in record
                                                //BYTE 12-13: 0, ignore
